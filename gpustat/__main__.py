...
def main(*argv):
    ...
    parser.add_argument( '-y','--your-name',default='',
                        help='enter your name and only show your process. Example: --your_name wf')
    ...
    if args.interval > 0:
        ...
        del args.interval
        #print(vars(args))
        #{'show_cmd': False, 'force_color': False,
        # 'show_user': True, 'no_color': False,
        # 'show_pid': False, 'show_header': False, 'gpuname_width': 16,
        # 'json': False, 'debug': False, 'your_name': 'wf', 'show_power': None,
